    ...
    show(e){
        ...
        for(var i=0;i<this.state.std.length;i++)
        {
            ...
            if(this.state.num == this.state.std[i].num && this.state.pwd == this.state.std[i].pwd && this.state.code == mm)
            {
                ...
                console.log("登录成功");
                window.location.href="/Todoinput?num="+this.state.num;
                ccm ++;
            ...
            <div className="cc1">
                    ...
                    <div className="cc4">
                        ...
                        onChange={(e) => this.handleChange3(e) }
                                className="c22" />  
                        {/* <img src={this.state.n1} alt="" style={{width:'20%',height:'13%',marginLeft:'15px',marginTop:'30px',float:'left'}}/> */}
                        ...
                        <button style={{backgroundColor:'#eee',border:'none',outline:'none',float:'left',fontSize:'10px',marginLeft:'10px',marginTop:'20px'}} onClick={(e) => this.cc(e)}>换一换</button>
                        <p
